...
- **Restaurant / food ops** — ordering, kitchen display, staff roles, payments
- **Vendora** — multi-branch retail POS, admin, storefront, Docker
- **Commerce & ops** — e-commerce, logistics, invoicing, business admin panels
