...
export const projects: Project[] = [
  ...
  },
  {
    ...
    role: "Full Stack Developer",
    summary:
      "Full venue operations platform: floor tables, orders, multi-area kitchen displays, staff/HR scheduling, and HMRC-oriented accounting — delivered as a PWA on venue Docker Compose with on-LAN thermal printing.",
    problem:
      "Hospitality venues need one system for service floor, kitchen routing, workforce, payments messaging, and bookkeeping instead of fragmented tills, spreadsheets, and printers.",
    outcome:
      "Shipped Browser/PWA → Next.js (React + API) → PostgreSQL (Prisma), with Stripe/SumUp, Twilio, optional Redis, Cloudflare Tunnel, and an ESC/POS print-agent for thermal printers on the LAN.",
    technologies: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    features: [
      ...
      "Tables / floor system",
      "Orders and multi-kitchen displays",
      "Staff, HR, and scheduling",
      "Accounting and reports",
      "Stripe / SumUp payments + Twilio SMS",
      "On-LAN ESC/POS print agent",
      "Docker Compose venue deployment",
    ],
    images: [
      {
        src: "/projects/fumari-rms/hero.png",
        alt: "Tables system dashboard",
      },
      {
        src: "/projects/fumari-rms/orders.png",
        alt: "Orders dashboard",
      },
      {
        src: "/projects/fumari-rms/kitchen.png",
        alt: "Kitchen areas overview",
      },
      {
        src: "/projects/fumari-rms/kitchen-cocktail.png",
        alt: "Mocktail bar kitchen display",
      },
      {
        src: "/projects/fumari-rms/kitchen-main.png",
        alt: "Main kitchen display",
      },
      {
        src: "/projects/fumari-rms/kitchen-shisha.png",
        alt: "Shisha kitchen display",
      },
      {
        src: "/projects/fumari-rms/staff.png",
        alt: "Staff management",
      },
      {
        src: "/projects/fumari-rms/hr.png",
        alt: "HR module",
      },
      {
        src: "/projects/fumari-rms/hr-schedule.png",
        alt: "HR schedule",
      },
      {
        src: "/projects/fumari-rms/accounting.png",
        alt: "Accounting system",
      },
      {
        src: "/projects/fumari-rms/accounting-reports.png",
        alt: "Accounting reports",
      },
    ],
    liveUrl: "https://www.fumarisystem.com/",
    video: {
